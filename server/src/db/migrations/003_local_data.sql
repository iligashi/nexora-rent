...
INSERT IGNORE INTO `blog_posts` (`id`, `title`, `slug`, `content`, `excerpt`, `cover_image`, `author_id`, `is_published`, `published_at`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cars` (`id`, `brand`, `model`, `year`, `slug`, `category`, `fuel`, `transmission`, `seats`, `doors`, `horsepower`, `engine_cc`, `color`, `license_plate`, `vin`, `mileage`, `price_per_day`, `price_per_week`, `deposit`, `description`, `features`, `is_available`, `is_featured`, `sort_order`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `car_expenses` (`id`, `car_id`, `category`, `description`, `amount`, `expense_date`, `vendor`, `created_by`, `created_at`) VALUES
...
INSERT IGNORE INTO `car_images` (`id`, `car_id`, `url`, `alt_text`, `is_primary`, `sort_order`, `created_at`) VALUES
...
INSERT IGNORE INTO `contact_messages` (`id`, `name`, `email`, `phone`, `subject`, `message`, `is_read`, `created_at`) VALUES
('1a3cbd2c-b628-44c5-9609-66c434a7783d', 'test', 'ili@gmail.com', '+38349888888', 'Rent', 'Per Audi A6', 1, '2026-03-28 11:36:12');
INSERT IGNORE INTO `extras` (`id`, `name`, `description`, `price_per_day`, `icon`, `is_active`) VALUES
...
INSERT IGNORE INTO `locations` (`id`, `name`, `address`, `city`, `lat`, `lng`, `is_active`) VALUES
...
INSERT IGNORE INTO `loyalty_rewards` (`id`, `name`, `description`, `type`, `value`, `points_cost`, `is_active`, `min_tier`) VALUES
...
INSERT IGNORE INTO `maintenance_records` (`id`, `car_id`, `maintenance_type_id`, `status`, `scheduled_date`, `completed_date`, `mileage_at_service`, `next_due_mileage`, `next_due_date`, `cost`, `vendor`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `maintenance_types` (`id`, `name`, `description`, `interval_km`, `interval_days`, `estimated_cost`, `is_active`) VALUES
...
INSERT IGNORE INTO `notification_log` (`id`, `reservation_id`, `user_id`, `type`, `channel`, `recipient`, `status`, `error_message`, `sent_at`, `created_at`) VALUES
...
INSERT IGNORE INTO `notification_templates` (`id`, `type`, `channel`, `template_name`, `template_body`, `is_active`) VALUES
...
INSERT IGNORE INTO `pricing_rules` (`id`, `name`, `type`, `car_id`, `category`, `multiplier`, `conditions`, `priority`, `is_active`, `start_date`, `end_date`, `created_at`) VALUES
...
INSERT IGNORE INTO `reservation_extras` (`id`, `reservation_id`, `extra_id`, `quantity`, `price`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `email`, `password_hash`, `first_name`, `last_name`, `phone`, `role`, `avatar_url`, `is_verified`, `created_at`, `updated_at`) VALUES
